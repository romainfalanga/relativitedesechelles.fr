        ...
        <div className="space-y-8 relative z-10">
          ...
          <div className="futuristic-card p-8 md:p-10 rounded-3xl border-cyan-500/30 hover:border-cyan-400/50">
            ...
            <div className="text-center relative z-10">
              <h3 className="text-2xl font-orbitron font-bold text-cyan-300 mb-4">Reconnaissance</h3>
              <p className="text-gray-200 leading-relaxed">
                La Relativité des Échelles n'aurait pas pu voir le jour sans ces fondements théoriques exceptionnels. 
                Chaque formule, chaque concept développé par ces pionniers de la physique moderne constitue 
                une pierre angulaire de notre nouvelle compréhension unifiée de l'univers.
              </p>
              <p className="text-cyan-300 font-medium mt-4">
                Nous rendons hommage à leur génie et à leur contribution inestimable à la science.
              </p>
            </div>
          </div>
        </div>
